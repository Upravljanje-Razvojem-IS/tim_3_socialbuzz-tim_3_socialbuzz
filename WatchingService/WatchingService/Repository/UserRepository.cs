...
namespace WatchingService.Repository
{
    public class UserRepository : IUserRepository
    {
        ...
        public UserConfirmationDto Create(UserCreateDto dto)
        {
            ...
            _context.Users.Add(kreiranaUser);

            _context.SaveChanges();

            _logger.Log("Create User!");

            return _mapper.Map<UserConfirmationDto>(kreiranaUser);
        }
        ...
        public UserReadDto Get(Guid id)
        {
            ...
            _logger.Log("Preuzimanje Users po Id-u!");
